                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        <img src="../images/CNSC.png" style="width: 185px;" alt="logo">
                                        <h4 class="gradient-text mt-1 mb-5 pb-1"><b>BITSCON 2024 ATTENDANCE TRACKING
                                                FORM</b></h4>
                                    </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                ...
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h1 class="mb-8 text-center">Welcome to BITSCON 2024!</h1>
                                    <img class="robot" src="../images/robot.png" alt="image" width="350" height="300">
                                    <br>
                                    <p style="text-align: justify;">Join us for an electrifying event packed with
                                        excitement, unparalleled experiences, and a
                                        wealth of knowledge on the latest innovations shaping our world. Immerse
                                        yourself in inspiring talks,
                                        engage with cutting-edge technologies, and connect with like-minded individuals
                                        passionate about pushing boundaries and driving progress.
                                        BITSCON 2024 promises to ignite your imagination, expand your horizons, and
                                        leave you inspired to shape the future.</p>
                                </div>
